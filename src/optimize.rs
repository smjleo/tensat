...
impl CostModel {
    ...
    pub fn get_self_cost(&self, egraph: &EGraph<Mdl, TensorAnalysis>, enode: &Mdl) -> f32 {
        ...
        match enode {
            ...
            Mdl::DotGeneralOp([lhs, rhs, lhs_batch_dim, rhs_batch_dim, lhs_contract_dim, rhs_contract_dim, precision_config, cost]) => x(cost).val as f32,
            ...
            Mdl::IotaOp([iota_dimension, shape, cost]) => x(cost).val as f32,
